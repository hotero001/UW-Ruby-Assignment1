...
def bank_statement
  ...
  def read_txs
    File.open("/Users/hotero001/Documents/assignment02-input.csv") do |file|
  ...
  def write_html(html)
    File.open("/Users/hotero001/Documents/assignment02-output.html", "w") do |file|
      file.write html
    end
  end
...
#----- CSV TO HTML WITH CLASSES IMPLEMENTED
...
#-------- RANDOM ATTEMPTS AT DOING STUFF
